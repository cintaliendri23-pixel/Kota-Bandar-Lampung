...
map.getView().fit([11677273.626507, -631342.029217, 11752336.172468, -582126.038012], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Data Kota Bandar Lampung</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (94 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Sumber Data:<br />1. Badan Pusat Statistik Kota Bandar Lampung<br />2. Ina-Geoportal Tanah Air Indonesia';
            }
