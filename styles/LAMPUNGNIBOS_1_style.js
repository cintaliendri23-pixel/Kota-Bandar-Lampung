...
var style_LAMPUNGNIBOS_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 164.000000 && value <= 216.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 216.000000 && value <= 241.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 241.333333 && value <= 544.000000) {
            style = [ new ol.style.Style({
